...
(function () {
  ...
  function draw(opts) {
    ...
    for (var i = 0; i < num; i++) {
      ...
      html.push('<li class="gb-turntable-item"> <p style="');
      html.push(transform + ': rotate(' + i * turnNum + 'turn)">');
      html.push('<span>'+prizeList[i].blockName+'</span>');
  ...
  function runRotate(deg) {
    ...
    document.getElementById("lightBulb").style[transform] = 'rotate(-' + deg + 'deg)';
  }
